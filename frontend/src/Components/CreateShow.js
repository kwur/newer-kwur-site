...
const CreateShow = () => {
    ...
    const timeValidation = (choice, numberChoice) => {
        ...
        const startHour = choice.startTime.substring(0, 2)
        const startMinute = choice.startTime.substring(3)
        const endHour = choice.endTime.substring(0, 2)
        const endMinute = choice.endTime.substring(3)
    ...
    const handleSubmit = (e) => {
        ...
        const firstChoiceStartTime = form.firstChoiceStartTime.value
        const firstChoiceEndTime = form.firstChoiceEndTime.value
        ...
        if(showSecond === true) {
            secondChoice = {
                ...
                startTime: form.secondChoiceStartTime.value,
                endTime: form.secondChoiceEndTime.value,
            }
        ...
        if(showThird === true) {
            thirdChoice = {
                ...
                startTime: form.thirdChoiceStartTime.value,
                endTime: form.thirdChoiceEndTime.value,
            }
